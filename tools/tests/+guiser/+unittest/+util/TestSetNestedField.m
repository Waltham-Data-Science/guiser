...
%TestSetNested Comprehensive unit tests for the guiser.util.setNested function.
    ...
    methods(Test)
        ...
        function testSimpleAssignment(testCase)
            ...
            s_out = guiser.util.setNestedField(s_in, 'a', 99);
            testCase.verifyEqual(s_out.a, 99);

            s_in_nest = testCase.NestedStruct;
            s_out_nest = guiser.util.setNestedField(s_in_nest, 'b.d.e', 101);
            testCase.verifyEqual(s_out_nest.b.d.e, 101);
        end

        function testNewFieldCreation(testCase)
            s_in = testCase.SimpleStruct;
            s_out = guiser.util.setNestedField(s_in, 'x.y.z', 500);
            testCase.verifyEqual(s_out.x.y.z, 500);
        end

        function testIndexedAssignment(testCase)
            s_new = guiser.util.setNestedField(testCase.ArrayStruct, 'a(1).b.c', 99);
            testCase.verifyEqual(s_new.a(1).b.c, 99);
            
            s_new_ext = guiser.util.setNestedField(testCase.ArrayStruct, 'a(4).b.c', 101);
        ...
        function testSetSingleValueToRange(testCase)
            ...
            s_new = guiser.util.setNestedField(s, 'a(1:2).b.c', 999);
        ...
        function testSetRange(testCase)
            ...
            s_new = guiser.util.setNestedField(s, 'a(1:2).b.c', values_to_set, 'SetRange', true);
            ...
            s_new_full = guiser.util.setNestedField(s, 'a(:).b.c', values_to_set_full, 'SetRange', true);
            ...
            testCase.verifyError(...
                @() guiser.util.setNestedField(s, 'a(1:2).b.c', {1}, 'SetRange', true), ...
                'setNestedField:SetRangeSizeMismatch');
            
            testCase.verifyError(...
                @() guiser.util.setNestedField(s, 'a(1:2).b.c', [1 2], 'SetRange', true), ...
                'setNestedField:SetRangeValueNotCell');
            
            testCase.verifyError(...
                @() guiser.util.setNestedField(s, 'a', {1}, 'SetRange', true), ...
                'setNestedField:SetRangeNoIndex');
        end
        
        function testInputValidationAndOptions(testCase)
            s = testCase.SimpleStruct;
            testCase.verifyError(@() guiser.util.setNestedField(123, 'a', 1), 'setNestedField:invalidInputType');
            
            testCase.verifyError(...
                @() guiser.util.setNestedField(s, 'c', 5, 'ErrIfDoesNotExist', true), ...
                'setNestedField:fieldNotFound');

            testCase.verifyError(@() guiser.util.setNestedField(s, 'a..b', 5), 'stringToSubstruct:invalidFieldString');
        end
    end
end
